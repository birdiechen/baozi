...
function winORlose() {
	...
	setTimeout(function() {
		...
		if (eat_count <= 20) {
			chat = eat_count + "小笼女吃的不过瘾，还要你请她吃包子！！";
			share = "我邀请小笼女吃了" + eat_count + "个包子，打败了5%的人，她说还没填饱";
			share_imgUrl = "http://zszclub.oss-cn-hangzhou.aliyuncs.com/11.jpgD"
		} else {
			if (eat_count <= 35) {
				chat = "我勒个去，我邀请小笼女只吃了" + eat_count + "个包子，摸死了";
				share = "我邀请小笼女吃掉了" + eat_count + "个包子，打败了15%的人，她说还没填饱";
				share_imgUrl = "http://zhenpinimg.b0.upaiyun.com/wine/11.jpg"
			} else {
				if (eat_count <= 50) {
					chat = "唉哟不赖，一口气吃" + eat_count + "个，吃完包子记得喝碗汤呀";
					share = "我邀请小笼女吃了" + eat_count + "个包子，打败了25%的人，求填饱";
					share_imgUrl = "http://zhenpinimg.b0.upaiyun.com/wine/11.jpg"
				} else {
					if (eat_count <= 65) {
						chat = "万万没有想到！你吃了" + eat_count + "个包子！放胆吃，吃饱了哥请你喝碗马虎！";
						share = "我邀请小笼女吃了" + eat_count + "个包子，打败了35%的人，求填饱";
						share_imgUrl = "http://zhenpinimg.b0.upaiyun.com/wine/11.jpg"
					} else {
						if (eat_count <= 80) {
							chat = "你吃了" + eat_count + "个包子，看样子你根本停不下来，加油，再来一次更牛的！！";
							share = "我邀请小笼女吃了" + eat_count + "个包子，打败了45%的人，求填饱";
							share_imgUrl = "http://zhenpinimg.b0.upaiyun.com/wine/11.jpgg"
						} else {
							if (eat_count <= 95) {
								chat = "你吃了" + eat_count + "个包子，这样的速度，标准的一吃货啊，有潜质 ！";
								share = "我邀请小笼女吃了" + eat_count + "个包子，打败了55%的人，求填饱";
								share_imgUrl = "http://zhenpinimg.b0.upaiyun.com/wine/11.jpg"
							} else {
								if (eat_count <= 110) {
									chat = "你吃了" + eat_count + "个包子，我看你天赋异禀、骨骼惊奇，想来是百年难得一见的吃货奇才！";
									share = "我邀请小笼女吃了" + eat_count + "个包子，打败了65%的人，求填饱";
									share_imgUrl = "http://zhenpinimg.b0.upaiyun.com/wine/11.jpg"
								} else {
									if (eat_count <= 125) {
										chat = "我勒个去，你吃了" + eat_count + "个包子…说点什么好？记得吃药…。";
										share = "我邀请小笼女吃了" + eat_count + "个包子，打败了75%的人，求填饱";
										share_imgUrl = "http://zhenpinimg.b0.upaiyun.com/wine/11.jpg"
									} else {
										if (eat_count <= 140) {
											chat = "你吃了" + eat_count + "个包子，这么快的速度，够神啊";
											share = "我邀请小笼女吃了" + eat_count + "个包子，打败了85%的人，求填饱";
											share_imgUrl = "http://zhenpinimg.b0.upaiyun.com/wine/11.jpg"
										} else {
											chat = "天啊，你竟然吃了" + eat_count + "个包子，简直是神一般的存在，膜拜啦！";
											share = "我邀请小笼女吃了" + eat_count + "个包子，打败了95%的人，求填饱";
											share_imgUrl = "http://zhenpinimg.b0.upaiyun.com/wine/11.jpg"
										}
									}
								}
...
function(a) {
	a.preventDefault();
	a.stopPropagation();
	window.location.href = "http://zszclub.com"
});
...
$(function() {});
var shareUrl = "http://zaoshi.jd-app.com/",
shareTitle = "一起邀请小笼女吃包子，求填饱！",
share = "一起邀请小笼女吃包子，求填饱！",
share_imgUrl = "http://zszclub.oss-cn-hangzhou.aliyuncs.com/11.jpg";
var onBridgeReady = function() {
	...
	function(b) {
		...
		WeixinJSBridge.invoke("sendAppMessage", {
			img_url: "http://zhenpinimg.b0.upaiyun.com/wine/11.jpg",
			img_width: "240",
			img_height: "240",
			link: c,
			desc: d,
		...
		function(g) {
			location.href = "http://mp.weixin.qq.com/s?__biz=MjM5MzgzMjk5Mw==&mid=201458255&idx=1&sn=1c0f398cd29b579b2b48793d646872c4#rd";
		})
	});
